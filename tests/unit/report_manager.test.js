...
describe('Report & Message Manager Feature Tests', () => {
  ...
  it('verifies Report Manager HTML elements exist in compiled index.html', () => {
    ...
    assert.strictEqual(indexHtml.includes('id="rm-tab-btn-meeting_recap"'), true);
    assert.strictEqual(indexHtml.includes('id="rm-tab-btn-member_remind"'), true);
    assert.strictEqual(indexHtml.includes('id="rm-tab-btn-weekly_summary"'), true);
    assert.strictEqual(indexHtml.includes('id="rm-tab-btn-action_cleared"'), true);
